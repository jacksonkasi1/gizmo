...
import WatchTopTab from '../../navigation/WatchTopTab'
    ...
    return (
        <Screen styles={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerName}>Watch History</Text>
            ...
            <WatchTopTab screen={'WatchHistory'}/>
            <BottomModal
