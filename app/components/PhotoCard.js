    ...
    <View style={[styles.cardmain, style]}>
      ...
      {mainImage && (
        <View style={styles.secmainbg}>
          {/* image */}
          <ImageBackground style={styles.seccardbg} source={mainImage}>
            {/* DropBack */}
      ...
      <View style={styles.sectextmain}>
        <Text style={styles.seccardtext}>{contentDescription}</Text>
        {hashTag && (
          <Text
            style={{
              fontSize: FontSizes.regular,
                ...
                >
                  <View style={{ width: "20%" }}>
                    <Image
                      ...
                      source={itm.image_url===undefined?null:itm.image_url.url}
                    />
                  </View>
                  <LinearGradient
                    style={{
                  ...
                  >
                    ...
                    >
                      {itm.count==undefined?null:itm.count}
                    </Text>
                  </LinearGradient>
                </TouchableOpacity>
              ))}
